package com.fitness.assistant.data.databases.converters
...
object Converters {
    ...
    @TypeConverter
    @JvmStatic
    fun toUserGoal(value: String) = enumValueOf<UserGoal>(value)

    @TypeConverter
    @JvmStatic
    fun fromUserGoal(value: UserGoal) = value.name
