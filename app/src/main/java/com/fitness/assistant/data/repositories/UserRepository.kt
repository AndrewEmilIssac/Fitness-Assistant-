...
import com.fitness.assistant.data.interfaces.UserDeleteCallback
...
class UserRepository @Inject internal constructor(
    ...
    val userBurnedCalories: MutableLiveData<String> =
        MutableLiveData("-")
    ...
    fun updateBurnedCalories(burnedCalories:String){
        userBurnedCalories.postValue(burnedCalories);
    }
