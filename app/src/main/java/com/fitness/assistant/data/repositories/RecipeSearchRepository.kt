package com.fitness.assistant.data.repositories
...
@Inject internal constructor
    ...
    fun searchRecipe(query: String, caloriesSort: UserGoal) {
        try {
            isSearching.postValue(true)
            lateinit var sort: String
            if (caloriesSort == UserGoal.LOSE) sort = "asc" else {
                sort = "desc"
            }
            val call = searchRecipes(query, intolerance, diet, sort) ?: return
